...
function ContactLogo() {
  return (
    ...
    <a href='https://www.linkedin.com/in/adréan-rodriguez-60aa3b28a' target="_blank" className='logo-div'>
      <img className='logo' src={likedIn} alt="Logo LinkedIn" />
    </a>

    <a href='https://github.com/AdreanRodriguez' target='_blank' className='logo-div'>
      <img className='logo' src={gitHub} alt="Logo GitHub" />
    </a>

    <a href='mailto:Adrean.R@hotmail.com' target='_blank' className='logo-div'>
